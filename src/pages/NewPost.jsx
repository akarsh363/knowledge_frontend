...
// // // // // // //       const allTags = Array.isArray(res.data) ? res.data : (res.data?.$values || [])
// // // // // // //       const normalized = allTags.map(t => ({
// // // // // // //         tagId: t.tagId ?? t.TagId ?? t.id,
// // // // // // //         tagName: (t.tagName ?? t.TagName ?? t.name ?? '').toString(),
// // // // // // //         deptId: t.deptId ?? t.DeptId ?? t.deptId
// // // // // // //       }))
// // // // // // //       const filtered = normalized.filter(t => t.tagName.toLowerCase().includes(query.toLowerCase()))
...
// // // // // // //                   {tag}{' '}
// // // // // // //                   <button type="button" onClick={() => removeTag(tag)} style={{ marginLeft: '0.25rem' }}>
// // // // // // //                     ✖
// // // // // // //                   </button>
// // // // // // //                 </span>
// // // // // // //               ))}
...
// // // // //     // Debug: show what would be submitted
...
// // // // //     // If user typed content but didn't click "Add Block", auto-add as a block
...
// // // // //       // Navigate to created post (handles different id shapes)
...
// // // // //   // Button should be enabled if title OR textarea content OR blocks exist
// // // // //   const canSubmit = !submitting && (title.trim().length > 0 || input.trim().length > 0 || blocks.length > 0)
...
// // // //   // Load all tags once to validate user selection
// // // //   useEffect(() => {
// // // //     loadAllTags()
// // // //   }, [])
...
// // // //   // Only allow tags that exist in DB
// // // //   function addTag(tag) {
// // // //     if (!tags.includes(tag)) {
...
// // // //       // --- NEW: include DeptId pulled from auth (if available) ---
// // // //       const auth = getAuth?.() ?? (typeof window !== 'undefined' ? JSON.parse(localStorage.getItem('auth') || '{}') : {})
// // // //       const deptId =
// // // //         auth?.departmentId ??
// // // //         auth?.deptId ??
...
// // // //         auth?.departmentId ??
// // // //         0
// // // //       formData.append('DeptId', (deptId ?? 0).toString())
// // // //       // ----------------------------------------------------------------
...
// // //   // Utility to log FormData content (files will show name)
...
// // //       // DeptId from auth or fallback 0 (backend will try to resolve)
// // //       const auth = getAuth?.() ?? (typeof window !== 'undefined' ? JSON.parse(localStorage.getItem('auth') || '{}') : {})
// // //       const deptId =
// // //         auth?.departmentId ??
// // //         auth?.deptId ??
...
// // //       alert(serverMsg || 'Failed to create post')
// // //     } finally {
// // //       setSubmitting(false)
// // //     }
// // //   }
...
// //   const [files, setFiles] = useState([])
// //   const [submitting, setSubmitting] = useState(false)
// //   const [profile, setProfile] = useState(null) // <-- user profile (to get department)
// //   const navigate = useNavigate()

// //   // Load tags and user profile on mount
// //   useEffect(() => {
// //     loadAllTags()
// //     fetchProfile()
// //     // eslint-disable-next-line react-hooks/exhaustive-deps
...
// //     } catch (err) {
// //       console.warn('Failed to load profile (will rely on backend fallback):', err)
// //       setProfile(null)
// //     }
// //   }
...
// //     // Determine DeptId: prefer profile data fetched from /Users/me
// //     const deptIdFromProfile =
...
// //     if (!deptIdFromProfile || deptIdFromProfile === 0) {
// //       // If no dept on profile, stop and instruct user to set it — prevents the 400 you saw.
...
// //       formData.append('Title', title.trim())
// //       formData.append('Body', JSON.stringify(effectiveBlocks))
// //       formData.append('DeptId', (deptIdFromProfile ?? 0).toString())
...
//     // Ensure this comes from the logged-in user
...
//       // Surface server detail if available (helpful while debugging)
...
export default function NewPost() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Use a longer timeout for this upload and track progress
      const res = await api.post('/Posts', formData, {
        timeout: 60000, // 60s
        headers: { 'Content-Type': 'multipart/form-data' },
