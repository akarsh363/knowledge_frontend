...
//     try {
//       // api.baseURL already includes /api, so request path should NOT include /api prefix
...
//       setUserPosts(Array.isArray(data) ? data : (data?.$values || []))
...
//       // fallback: calculate from posts if API fails
//       setStats({
