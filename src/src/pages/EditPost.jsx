...
// //     try {
// //       setSubmitting(true)
// //       // If manager, require commit message and include as query param
// //       const msg = auth?.role === 'Manager' ? prompt('Enter commit message:') : null
// //       if (auth?.role === 'Manager' && !msg) {
// //         alert('Update cancelled: commit message required for managers.')
// //         return
// //       }
...
//         const formData = new FormData()
//         files.forEach(f => formData.append('files', f))
//         // Use correct controller casing for attachments endpoint
//         await api.post(`/Posts/${id}/attachments`, formData, {
//           headers: { 'Content-Type': 'multipart/form-data' }
//         })
//       }
